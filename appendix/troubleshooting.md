...
| `Answer with "function" action and handler ... is missing for intent ...`                                                            | Make sure that your chatbot training data defines the expected `{ "action": "...", "handler": "..." }` on the mentioned mandatory `intent` object as defined in the [Chatbot training data](chatbot.md) specification.                                                                                                                                                     |
