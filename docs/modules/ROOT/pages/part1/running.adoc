...
Juice Shop's _Support Chat_ chatbot requires an external LLM provider to function. By default, it connects to a local https://ollama.com[Ollama] instance at `http://localhost:11434/v1`.
