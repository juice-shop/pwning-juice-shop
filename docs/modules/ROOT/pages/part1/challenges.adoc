...
If not deliberately turned off (see xref:part1/customization.adoc#customization[Customization])
...
event. Please refer to chapter xref:part1/ctf.adoc#_hosting_a_ctf_event[Hosting a CTF event] for more
...
xref:part3/tutorials.adoc#_hacking_instructor_tutorial_scripts[Hacking Instructor tutorial scripts].
