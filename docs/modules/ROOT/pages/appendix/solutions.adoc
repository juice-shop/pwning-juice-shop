...
NOTE: The challenge solutions found in this release of the companion guide
...
// TODO Add solution for exposedCredentialsChallenge
...
// TODO Add solution for passwordHashLeakChallenge
...
// TODO Add solution for emptyUserRegistration

=== Reveal some behind-the-scenes information on the chatbot as a non-admin user

// TODO Add solution for aiDebuggingChallenge
...
// TODO Add solution for chatbotPromptInjectionChallenge
...
// TODO Add solution for chatbotGreedyInjectionChallenge
...
=== Extract the chatbot's system prompt using prompt injection

// TODO Add solution for systemPromptExtractionChallenge
...
TIP: With other ``BasketId``s you might need to play with the order of the
...
TIP: It is worth noting that both alternate solutions would still work even
if the CAPTCHA-pinning problem would be fixed in the application!
...
// TODO Add solution for csafChallenge
...
TIP: You might feel tempted to try the classic *Billion laughs attack* but
...
// TODO Add solution for leakedApiKeyChallenge
...
+
TIP: As this is not part of the Juice Shop repo itself and it is publicly accessible,
analyzing this repository is *not* considered cheating!
. Open the
...
TIP: Remember that you need to use the right malware file for your
...
IMPORTANT: Solving this challenge requires http://keepass.info[KeePass 2.x]
