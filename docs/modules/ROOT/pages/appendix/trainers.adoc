...
Juice Shop offers
xref:part1/customization.adoc#customization[various customization options] to achieve
this.
...
want to xref:part1/ctf.adoc#_hosting_a_ctf_event[host a central CTF server] where participants
