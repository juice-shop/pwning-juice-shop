...
| http://localhost:3000/pass:[#]/score-board?challenge=DOM%20XSS or http://preview.owasp-juice.shop/pass:[#]/score-board?challenge=Score%20Board

| Link to a specific challenge on the Preview Score Board
| `/#/score-board-preview?searchQuery=<name>`
| Will filter the Score Board resulting in just the one matching challenge.
| http://localhost:3000/pass:[#]/score-board-preview?searchQuery=DOM%20XSS or http://preview.owasp-juice.shop/pass:[#]/score-board-preview?searchQuery=Score%20Board
