...
| Link to a specific challenge on the legacy Score Board
| `/#/score-board-legacy?challenge=<name>`
| Will scroll to the challenge, but only if it is visible as per the current filter settings.
| http://localhost:3000/pass:[#]/score-board-legacy?challenge=DOM%20XSS or http://preview.owasp-juice.shop/pass:[#]/score-board-legacy?challenge=Score%20Board
...
| `<hintUrl>`
|
| https://pwning.owasp-juice.shop/companion-guide/latest/part2/score-board.html#_find_the_carefully_hidden_score_board_page or https://pwning.owasp-juice.shop/companion-guide/latest/part2/xss.html#_perform_a_dom_xss_attack

| Link to official step-by-step solution for a specific challenge
| `+https://pwning.owasp-juice.shop/companion-guide/latest/appendix/solutions.html#<hash part of hintUrl>+`
|
| https://pwning.owasp-juice.shop/companion-guide/latest/appendix/solutions.htmlpass:[#]_find_the_carefully_hidden_score_board_page or https://pwning.owasp-juice.shop/companion-guide/latest/appendix/solutions.htmlpass:[#]_perform_a_dom_xss_attack
