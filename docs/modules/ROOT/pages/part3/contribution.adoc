...
. Low-effort contributions (e.g. typo fixes, text changes) or any forms of potential "contribution farming" _must not_ be submitted as PRs. Doing so more than once _might be_ <<_handling_of_spam_prs,considered spamming and handled accordingly>>.
