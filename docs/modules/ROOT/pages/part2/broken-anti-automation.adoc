...
include::partial$hints/captchaBypassChallenge.adoc[]
...
include::partial$hints/extraLanguageChallenge.adoc[]
...
include::partial$hints/timingAttackChallenge.adoc[]
...
include::partial$hints/resetPasswordMortyChallenge.adoc[]
