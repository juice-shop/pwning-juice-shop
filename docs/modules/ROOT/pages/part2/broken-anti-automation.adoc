...
include::ROOT:partial$hints/captchaBypassChallenge.adoc[]
...
include::ROOT:partial$hints/extraLanguageChallenge.adoc[]
...
include::ROOT:partial$hints/timingAttackChallenge.adoc[]
...
include::ROOT:partial$hints/resetPasswordMortyChallenge.adoc[]
