...
should never be the only security mechanism.footnote:3_9_1[https://en.wikipedia.org/wiki/Security_through_obscurity]
____
...
which sells a share in the ownership of the company itself.footnote:3_9_2[https://en.wikipedia.org/wiki/Initial_coin_offering]
____

include::ROOT:partial$hints/tokenSaleChallenge.adoc[]
...
include::ROOT:partial$hints/privacyPolicyProofChallenge.adoc[]
...
for it is unlikely to notice the change.footnote:3_9_3[https://en.wikipedia.org/wiki/Steganography]
____

include::ROOT:partial$hints/hiddenImageChallenge.adoc[]
