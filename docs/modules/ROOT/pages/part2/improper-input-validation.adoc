...
include::ROOT:partial$hints/registerAdminChallenge.adoc[]
...
include::ROOT:partial$hints/freeDeluxeChallenge.adoc[]

== Register a user with an empty email and password

include::ROOT:partial$hints/emptyUserRegistration.adoc[]
...
include::ROOT:partial$hints/manipulateClockChallenge.adoc[]

== Mint the Honey Pot NFT by gathering BEEs from the bee haven

include::ROOT:partial$hints/nftMintChallenge.adoc[]
...
include::ROOT:partial$hints/missingEncodingChallenge.adoc[]
...
include::ROOT:partial$hints/negativeOrderChallenge.adoc[]
...
include::ROOT:partial$hints/nullByteChallenge.adoc[]
...
include::ROOT:partial$hints/passwordRepeatChallenge.adoc[]
...
include::ROOT:partial$hints/uploadSizeChallenge.adoc[]
...
include::ROOT:partial$hints/uploadTypeChallenge.adoc[]
...
include::ROOT:partial$hints/zeroStarsChallenge.adoc[]
