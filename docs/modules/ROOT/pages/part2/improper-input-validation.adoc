...
// HINTS_START:registerAdminChallenge
...
// HINTS_END:registerAdminChallenge
...
// TODO Add hints for "Empty User Registration" challenge
...
// TODO Add hints for "Mint the Honey Pot" challenge
