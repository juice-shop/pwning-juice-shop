...
include::partial$hints/registerAdminChallenge.adoc[]
...
include::partial$hints/freeDeluxeChallenge.adoc[]

== Register a user with an empty email and password

include::partial$hints/emptyUserRegistration.adoc[]
...
include::partial$hints/manipulateClockChallenge.adoc[]

== Mint the Honey Pot NFT by gathering BEEs from the bee haven

include::partial$hints/nftMintChallenge.adoc[]
...
include::partial$hints/missingEncodingChallenge.adoc[]
...
include::partial$hints/negativeOrderChallenge.adoc[]
...
include::partial$hints/nullByteChallenge.adoc[]
...
include::partial$hints/passwordRepeatChallenge.adoc[]
...
include::partial$hints/uploadSizeChallenge.adoc[]
...
include::partial$hints/uploadTypeChallenge.adoc[]
...
include::partial$hints/zeroStarsChallenge.adoc[]
