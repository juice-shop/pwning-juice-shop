...
image::part1/devtools_network.png[XHR requests to the backend API]
...
include::../../partials/hints/restfulXssChallenge.adoc[]
...
include::../../partials/hints/xssBonusChallenge.adoc[]
...
include::../../partials/hints/usernameXssChallenge.adoc[]
...
include::../../partials/hints/persistedXssUserChallenge.adoc[]
...
include::../../partials/hints/localXssChallenge.adoc[]
...
include::../../partials/hints/httpHeaderXssChallenge.adoc[]
...
include::../../partials/hints/reflectedXssChallenge.adoc[]
...
TIP: When you actually understand a security mechanism you have a lot higher
chance to beat or trick it somehow, than by using a trial and error
approach.

include::../../partials/hints/persistedXssFeedbackChallenge.adoc[]
...
include::../../partials/hints/videoXssChallenge.adoc[]
