...
include::ROOT:partial$hints/svgInjectionChallenge.adoc[]
...
include::ROOT:partial$hints/deprecatedInterfaceChallenge.adoc[]
...
include::ROOT:partial$hints/errorHandlingChallenge.adoc[]
...
include::ROOT:partial$hints/loginSupportChallenge.adoc[]
