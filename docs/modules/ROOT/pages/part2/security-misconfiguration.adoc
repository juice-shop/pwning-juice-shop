...
image::part1/deluxe-membership.png[Vanilla Deluxe Membership page]

include::../../partials/hints/svgInjectionChallenge.adoc[]
...
include::../../partials/hints/deprecatedInterfaceChallenge.adoc[]
...
include::../../partials/hints/errorHandlingChallenge.adoc[]
...
Infrastructure as Code (IaC) is a great way to automate the deployment
of cloud resources. Even if they do not by mistake contain hard-coded secrets,
they should be treated as sensitive because they contain information
about the cloud environment and its security posture.

include::../../partials/hints/misplacedIacFiles.adoc[]
...
include::../../partials/hints/loginSupportChallenge.adoc[]
