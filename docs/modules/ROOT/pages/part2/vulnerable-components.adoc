...
include::../../partials/hints/fileWriteChallenge.adoc[]
...
include::../../partials/hints/jwtUnsignedChallenge.adoc[]
...
include::../../partials/hints/typosquattingAngularChallenge.adoc[]

NOTE: There is no actual malice or mischief included, as the typosquatter
...
include::../../partials/hints/killChatbotChallenge.adoc[]
...
include::../../partials/hints/typosquattingNpmChallenge.adoc[]
...
include::../../partials/hints/lfrChallenge.adoc[]
...
NOTE: Please note that having the OWASP Juice Shop installed on your
...
include::../../partials/hints/supplyChainAttackChallenge.adoc[]
...
include::../../partials/hints/jwtForgedChallenge.adoc[]

[[_inform_the_shop_about_the_use_of_a_known_vulnerable_infrastructure_component]]
== Inform the shop about the use of a known vulnerable infrastructure component

This challenge is about identifying and reporting (via the
http://localhost:3000/#/complain form) a case of a vulnerable component in the
underlying infrastructure of the Juice Shop that the attacker should not even
know about.

include::../../partials/hints/vulnerableDockerImageChallenge.adoc[]
...
include::../../partials/hints/knownVulnerableComponentChallenge.adoc[]
