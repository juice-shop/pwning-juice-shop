...
xref:part2/improper-input-validation.adoc#_improper_input_validation[Improper Input Validation] category.
...
* Other than with
<<_reset_the_password_of_bjoerns_owasp_account_via_the_forgot_password_mechanism,his OWASP account>>,
