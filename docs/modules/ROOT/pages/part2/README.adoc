...
| Login Cloud Admin
| Log in with the cloud admin's user account _without_ using SQL Injection.
| xref:part2/sensitive-data-exposure.adoc#_log_in_with_the_cloud_admins_user_account[💡]
...
| Misplaced IaC Files
| Access the misplaced Infrastructure as Code files that were accidentally included in the web application deliverable.
| xref:part2/security-misconfiguration.adoc#_access_the_misplaced_infrastructure_as_code_files[💡]
...
| xref:part2/sensitive-data-exposure.adoc#_obtain_the_password_hash_of_the_currently_logged_in_user_directly_from_a_rest_api_endpoint[💡]
...
| xref:part2/injection.adoc#_extract_the_chatbots_system_prompt[💡]
...
| Inform the shop about the use of a known vulnerable infrastructure component. (Identify the component as specifically as possible in your complaint)
| xref:part2/vulnerable-components.adoc#_inform_the_shop_about_the_use_of_a_known_vulnerable_infrastructure_component[💡]

| Vulnerable Library
| Inform the shop about a high-severity vulnerability. (Mention the exact library name and version in your comment)
...
| Log in with the cloud admin's user account _without_ using SQL Injection.
| xref:part2/sensitive-data-exposure.adoc#_log_in_with_the_cloud_admins_user_account[💡]
| xref:appendix/solutions.adoc#_log_in_with_the_cloud_admins_user_account[📕]
...
| Access the misplaced Infrastructure as Code files that were accidentally included in the web application deliverable.
| xref:part2/security-misconfiguration.adoc#_access_the_misplaced_infrastructure_as_code_files[💡]
| xref:appendix/solutions.adoc#_access_the_misplaced_infrastructure_as_code_files[📕]
...
| Obtain the password (hash) of the currently logged-in user directly from a REST API endpoint.
| xref:part2/sensitive-data-exposure.adoc#_obtain_the_password_hash_of_the_currently_logged_in_user_directly_from_a_rest_api_endpoint[💡]
| xref:appendix/solutions.adoc#_obtain_the_password_hash_of_the_currently_logged_in_user_directly_from_a_rest_api_endpoint[📕]
...
| Extract the chatbot's system prompt using prompt injection, then submit your findings (including any confidential sections) via the Customer Complaint form.
| xref:part2/injection.adoc#_extract_the_chatbots_system_prompt[💡]
| xref:appendix/solutions.adoc#_extract_the_chatbots_system_prompt[📕]
...
| Inform the shop about the use of a known vulnerable infrastructure component. (Identify the component as specifically as possible in your complaint)
| xref:part2/vulnerable-components.adoc#_inform_the_shop_about_the_use_of_a_known_vulnerable_infrastructure_component[💡]
| xref:appendix/solutions.adoc#_inform_the_shop_about_the_use_of_a_known_vulnerable_infrastructure_component[📕]
