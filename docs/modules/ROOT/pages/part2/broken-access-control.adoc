...
NOTE: Please also be aware that the challenge is designed to be solved only with
...
NOTE: When you open the easter egg file, you might be a little disappointed,
