...
[[_reveal_some_behind_the_scenes_information_on_the_chatbot_as_a_non_admin_user]]
== Reveal some behind-the-scenes information on the chatbot as a non-admin user

The support chatbot has a debugging feature that is intended to be used only
by administrators. This feature shows the internal tool calls and system
messages, providing valuable insight into what the AI is doing behind the scenes.

include::../../partials/hints/aiDebuggingChallenge.adoc[]
...
include::../../partials/hints/adminSectionChallenge.adoc[]
...
include::../../partials/hints/csrfChallenge.adoc[]

IMPORTANT: Please also be aware that the challenge is designed to be solved only with
...
such as for example JSFiddle or CodePen.
...
include::../../partials/hints/easterEggLevelOneChallenge.adoc[]

TIP: When you open the easter egg file, you might be a little disappointed,
...
include::../../partials/hints/feedbackChallenge.adoc[]
...
include::../../partials/hints/forgedFeedbackChallenge.adoc[]
...
include::../../partials/hints/forgedReviewChallenge.adoc[]
...
include::../../partials/hints/basketManipulateChallenge.adoc[]
...
include::../../partials/hints/changeProductChallenge.adoc[]
...
include::../../partials/hints/ssrfChallenge.adoc[]
...
include::../../partials/hints/basketAccessChallenge.adoc[]

== Find an accidentally deployed code sandbox

include::../../partials/hints/web3SandboxChallenge.adoc[]
