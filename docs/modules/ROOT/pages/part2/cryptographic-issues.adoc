...
As you learned during xref:part1/happy-path.adoc#_happy_path[the "happy path" tour], the
web shop offers a __Coupon__ field to get a discount on your entire order
...
include::ROOT:partial$hints/forgedCouponChallenge.adoc[]
...
include::ROOT:partial$hints/continueCodeChallenge.adoc[]
...
to tackle the taunt of the developers and hunt down __the real__ easter
...
include::ROOT:partial$hints/easterEggLevelTwoChallenge.adoc[]
...
include::ROOT:partial$hints/premiumPaywallChallenge.adoc[]
...
xref:part3/donations.adoc#_donations[donations in part 3] of this book.
____
...
weren't experts!footnote:3_4_1[https://wiki.owasp.org/index.php/Guide_to_Cryptography]
____

include::ROOT:partial$hints/weirdCryptoChallenge.adoc[]
