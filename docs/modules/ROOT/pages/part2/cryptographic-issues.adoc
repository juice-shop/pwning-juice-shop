...
include::partial$hints/forgedCouponChallenge.adoc[]
...
include::partial$hints/continueCodeChallenge.adoc[]
...
include::partial$hints/easterEggLevelTwoChallenge.adoc[]
...
include::partial$hints/premiumPaywallChallenge.adoc[]
...
include::partial$hints/weirdCryptoChallenge.adoc[]
