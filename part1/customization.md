...
| `showCodeSnippets`                         | Shows or hides the underlying vulnerable code snippet for each challenge on the score board (if available). Can be `none`, `solved` or `always`.                                                                                  | `always`                                                                                                                                                                                                                                                                                                          |
