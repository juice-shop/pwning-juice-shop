...
> :warning: **A major rewrite for version 8.x is currently ongoing!
> Several hints and solutions are still for the 7.x version and might
> not work as-is on 8.x! The content will be incrementally updated for
> 8.x only on GitBook!**
>
> To download the last edition of this book that is fully compatible
> with 7.x, please visit <https://leanpub.com/juice-shop>. LeanPub will
> not be re-published before the transition to 8.x is completed.
