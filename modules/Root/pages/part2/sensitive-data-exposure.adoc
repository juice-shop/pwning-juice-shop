...
* Solving the
link:injection.adoc#order-the-christmas-special-offer-of-2014[Order the Christmas special offer of 2014]
...
link:broken-authentication.adoc#log-in-with-the-administrators-user-credentials-without-previously-changing-them-or-applying-sql-injection[Log in with the administrators user credentials without previously changing them or applying SQL Injection]
