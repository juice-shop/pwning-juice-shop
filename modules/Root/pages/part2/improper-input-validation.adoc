...
link:sensitive-data-exposure.adoc#access-a-salesmans-forgotten-backup-file[Access a salesman's forgotten backup file],
link:sensitive-data-exposure.adoc#access-a-misplaced-siem-signature-file[Access a misplaced SIEM signature file.]
or
link:broken-access-control.adoc#find-the-hidden-easter-egg[Find the hidden easter egg]
along the way.
