...
link:miscellaneous.adoc#read-our-privacy-policy[Read our privacy policy].
...
uncovered in
link:cryptographic-issues.adoc#apply-some-advanced-cryptanalysis-to-find-the-real-easter-egg[Apply some advanced cryptanalysis to find the real easter egg].
