...
link:injection.adoc#retrieve-a-list-of-all-user-credentials-via-sql-injection[Retrieve a list of all user credentials via SQL Injection]
...
link:injection.adoc#log-in-with-the-administrators-user-account[Log in with the administrator's user account]
