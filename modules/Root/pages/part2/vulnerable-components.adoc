...
* Investigating the
link:sensitive-data-exposure.adoc#access-a-developers-forgotten-backup-file[forgotten developer's backup file]
...
hacking.
* Solving
link:sensitive-data-exposure.adoc#access-a-developers-forgotten-backup-file[Access a developer's forgotten backup file]
...
link:cryptographic-issues.adoc#inform-the-shop-about-an-algorithm-or-library-it-should-definitely-not-use-the-way-it-does[Inform the shop about an algorithm or library it should definitely not use the way it does]
