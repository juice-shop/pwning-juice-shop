...
link:../part1/ctf.adoc#generating-challenge-import-files-with-juice-shop-ctf-cli[to retrieve the challenges to later import into a CTF score server].
...
individual link:../part1/customization.adoc#customization[Customization]
...
| Direct link to a link:../part1/challenges.adoc#hacking-instructor[Hacking Instructor] tutorial for a specific challenge
...
link:code-snippets.adoc#rest-endpoints[REST endpoints] section of the
...
https://www.npmjs.com/package/juice-shop-ctf-cli[Juice Shop CTF Extension]
calls the API of a specified Juice Shop instance
link:../part1/ctf.adoc#generating-challenge-import-files-with-juice-shop-ctf-cli[to retrieve the snippets to later offer them as a hint on a CTF score server].
