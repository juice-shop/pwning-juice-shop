...
some of its existing hacking challenges: Coding challenges. These were link:../part1/challenges.adoc#coding-challenges[briefly illustrated in Part 1 of this book]
...
automatically as a job of the link:../part3/contribution.adoc#cicd-pipeline[CI/CD pipeline] but can also be launched locally
with `npm run rsn`.
...
link:../part1/challenges.adoc#coding-challenges[Coding Challenge dialog of the running application] or by comparing the source code files.
