...
. Read the link:../part1/challenges.adoc#success-notifications[Success Notifications] section
...
link:../part2/security-misconfiguration.adoc#log-in-with-the-support-teams-original-user-credentials[Log in with the support team's original user credentials]
...
. Following
link:../part2/sensitive-data-exposure.adoc#gain-access-to-any-access-log-file-of-the-server[the hint to drill down deeper than one level],
...
. Solve
link:../part2/sensitive-data-exposure.adoc#access-a-developers-forgotten-backup-file[Access a developer's forgotten backup file]
