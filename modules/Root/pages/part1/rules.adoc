...
is required by the xref:part1/customization.adoc#customization[Customization] feature that allows
...
endpoint is unavoidable for the xref:part1/customization.adoc#customization[Customization]
