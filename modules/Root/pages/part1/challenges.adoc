...
link:../appendix/trainers.adoc#challenges-for-demos[challenges which are suitable for live demos]
...
The link:running.adoc#self-healing-feature[_self-healing_ feature] - by
...
link:../part2/score-board.adoc#find-the-carefully-hidden-score-board-page[Find the carefully hidden 'Score Board' page].
...
link:customization.adoc#yaml-configuration-file[YAML configuration file].
